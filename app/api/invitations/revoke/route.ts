...
export async function DELETE(request: NextRequest) {
  try {
    ...
    console.log('[DELETE /api/invitations/revoke] Revoking invitation:', invitationId);
    ...
    console.log('[DELETE /api/invitations/revoke] Calling revokeInvitation for:', invitation.id);
    const success = await revokeInvitation(invitation.id);
    console.log('[DELETE /api/invitations/revoke] Revoke result:', success);

    if (!success) {
      console.warn('[DELETE /api/invitations/revoke] Failed to revoke invitation:', invitation.id);
      return NextResponse.json(
    ...
    console.log('[DELETE /api/invitations/revoke] ✅ Invitation revoked successfully');
    return NextResponse.json({ 
      success: true,
